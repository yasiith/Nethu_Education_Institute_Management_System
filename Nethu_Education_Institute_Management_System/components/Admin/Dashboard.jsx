  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col items-start justify-center gap-5 py-5 md:flex-row">
        <div className="bg-teal-600 hover:bg-teal-700 transition-colors duration-300 rounded-[35px] text-white text-center p-5 w-full md:w-1/4 cursor-pointer">
        ...
        <div className="bg-gray-400 hover:bg-gray-500 rounded-[35px]  text-white text-center p-5 w-full md:w-1/4">
      ...
      <div className="flex flex-col items-start justify-center gap-5 pb-5 md:flex-row">
        ...
        <div className="bg-gray-300 hover:bg-gray-400 rounded-[35px] p-5 text-center w-full md:w-1/4">
        ...
        <button
          ...
          className="bg-red-500 bg-red-600 text-white text-center rounded-[25px] p-5 w-full md:w-1/4 text-2xl font-bold md:text-4xl">
