...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch("https://nethu-education-institute-management.onrender.com/api/auth/announcements", {
          method: "GET", 
          headers: {
            "x-auth-token": token, 
  ...
  const handleAdd = async () => {
    ...
    fetch("https://nethu-education-institute-management.onrender.com/api/auth/announcements", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
const handleEdit = (id) => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/auth/announcements/${editingId}`, {
        method: "PUT",
        headers: {
          "x-auth-token": token,
          "Content-Type": "application/json",
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/auth/announcements/${selectedForDelete._id}`, {
        method: "DELETE",
        headers: {
          "x-auth-token": token,
          "Content-Type": "application/json",
