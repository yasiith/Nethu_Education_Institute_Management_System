...
const StudentPaymentDetails = () => {
    ...
    useEffect(() => {
        ...
        const fetchPaymentDetails = async () => {
            try {
                const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/payments/${classId}/${studentId}`);
                if (!response.ok) {
        ...
        const fetchStudentName = async () => {
            try {
                const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/user/name/${studentId}`);
                if (response.ok) {
                    const data = await response.json();
    ...
    const fetchPaymentDetailsBySessionId = async (sessionId) => {
        try {
            const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/payment-details/${sessionId}`);
            if (!response.ok) {
                throw new Error('Failed to fetch payment details');
            }
            const data = await response.json();
    ...
    const handleSetAsPaid = async (month) => {
        ...
        try {
            const response = await fetch('https://nethu-education-institute-management.onrender.com/api/payments/create', {
                method: 'POST',
                headers: {
