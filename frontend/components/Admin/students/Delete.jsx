  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(
        `https://nethu-education-institute-management.onrender.com/api/auth/delete-student/${studentID}`,
        {
          method: "DELETE",
          headers: {
          ...
          <div className="md:flex">
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-700 md:w-2/5 p-8 flex flex-col justify-between">
              <div className="text-white">
                <h2 className="text-3xl font-bold mb-4">Delete Student</h2>
                <p className="opacity-80 mb-6">
                  Remove a student from your institution's database. This action cannot be undone.
                </p>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-red-700">
                        <p>
                          Deleting a student will permanently remove all their records from the system. This action cannot be undone.
                        </p>
                      </div>
                    </div>
                  </div>
