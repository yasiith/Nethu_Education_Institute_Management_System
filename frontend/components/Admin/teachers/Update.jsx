...
const Update = () => {
  ...
  const handleFindTeacher = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch(`https://nethu-education-institute-management.onrender.com/api/auth/getteacherinfo/${teacherID}`, {
        method: "GET",
        headers: {
  ...
  const handleUpdateTeacher = async () => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch(`https://nethu-education-institute-management.onrender.com/api/auth/updateteacher/${teacherID}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
