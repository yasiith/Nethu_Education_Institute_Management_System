...
const QuizAttemptPage = () => {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      ...
      try {
        const response = await fetch(`https://nethu-education-institute-management.onrender.com/api/quizzes/quize/${quizId}`);
        if (!response.ok) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://nethu-education-institute-management.onrender.com/api/quizzes/submit", {
        method: "POST",
